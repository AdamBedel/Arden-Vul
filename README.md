**Character Creation Rules**
  ...
  - All classic classes are allowed (Cleric, Dwarf, Elf, Fighter, Halfing, Magic-User, Thief) as well as the following advanced classes: Acolyte (cc1), Acrobat (Adv), Assassin (Adv), Barbarian (Adv), Beast Master (cc3), Druid (Adv), Goblin (cc1), Mage (cc1), Ranger (Adv)
  - Class Changes:
